...
import com.distribuida.mp.BookMapper;
...
private BookMapper bookMapper;
    ...
    @Override
    public Book encontrarLibro(long id) throws ExecutionException, InterruptedException {
    ...
    @Override
    public long actualizar(long id, Book book) {
        var rowsChanged = 0L;
        try {
            rowsChanged = this.dbClient
                    .execute(exec -> exec
